  ...
  return (
      <div className='flex justify-center items-center h-screen'>
        <div className='flex h-[500px] xl:h-[650px] lg:h-[500px] md:h-[500px] shadow-2xl rounded-xl'>
          <form onSubmit={handleSubmit} className='flex flex-col justify-center w-[400px] lg:w-[550px] md:w-[350px] items-center py-12 rounded-xl md:rounded-r-none'>
                ...
                <div className='absolute right-[107px] top-2'>
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className='text-white'>{alreadyUsed}</p>
                      </TooltipContent>      
                    </Tooltip>
                  </TooltipProvider>}  
                </div>
                ...
                <div className='absolute right-[107px] top-2'>
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className='text-white'>{errors.cpassword}</p>
                      </TooltipContent>      
                    </Tooltip>
                  </TooltipProvider>
                  }     
            ...
            <div className='flex flex-col items-center text-center gap-5 w-[50%]'>
              <button type='submit' onClick={handleUserSignup} className='bg-primary py-2 px-24 w-full rounded-md font-semibold hover:bg-red-700 text-white'>Sign up</button>
