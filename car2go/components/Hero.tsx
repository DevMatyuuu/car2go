...
export default function Hero() {
  return (
    <div className='flex md:flex-col lg:flex-row md:items-center xl:items-start lg:justify-between lg:px-48 lg:py-32 lg:pb-60 md:px-16 py-40 xl:pt-60 px-8 h-auto'>
